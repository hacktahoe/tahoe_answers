...
ActiveRecord::Schema.define(version: 20160522014618) do
  ...
  add_index "article_versions", ["item_type", "item_id"], name: "index_article_versions_on_item_type_and_item_id", using: :btree
  ...
  create_table "wordcounts", force: :cascade do |t|
    t.integer  "article_id"
