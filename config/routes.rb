Rails.application.routes.draw do
  devise_for :users, ActiveAdmin::Devise.config # devise_for :users, :controllers => { :sessions => "sessions" }
  ...
  resources :quick_answers, :only => :show, :via => :get
  resources :web_services, :only => :show, :via => :get
  resources :guides, :only => :show, :via => :get
  match '/articles/article-type/:content_type' => "articles#article_type", :via => [:get]
